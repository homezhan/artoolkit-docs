...
| Mac OS X, Windows                                 | QuickTimeÂ® (enhanced)            | AR\_INPUT\_QUICKTIME                                                                | -device=QUICKTIME                                 | 4.3.0                   |               |
| Windows                                           | DirectShowÂ®                      | AR\_INPUT\_WINDOWS\_DIRECTSHOW                                                       | -device=WinDS                                     | 4.0.0644                | 4.0.065,4.1.x |
| Windows                                           | DSVideoLib                        | AR\_INPUT\_WINDOWS\_DSVIDEOLIB                                                       | -device=WinDSVL                                   | 4.1.0                   |               |
| Windows                                           | DragonFly FlyCaptureÂ®            | AR\_INPUT\_WINDOWS\_DRAGONFLY                                                        | -device=WinDF                                     | 4.0.0644                | 4.0.065       |
| Mac OS X                                          | QuickTimeÂ®                       | AR\_INPUT\_QUICKTIME\_OLD                                                            | -device=QUICKTIME_OLD                             | 4.0.0                   |               |
...
| Mac OS X                                          | QuickTimeÂ® (v7.0 and later)      | AR\_INPUT\_QUICKTIME7                                                               | -device=QuickTime7                                | 4.5.0                   |               |

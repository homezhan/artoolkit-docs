...
-   A network connection (e.g. wifi or cellular data) is required to
    upload the data. Without this, the does not serve any useful
    purpose.
...
chessboard.pdf](/File:Calibration_chessboard.pdf "wikilink")

The "Calibration pattern.pdf" image consists of a grid of black and
...
[thumb|right|Chessboard pattern affixed to board ready for
calibration](/File:Chessboard_ready_for_calibration.JPG "wikilink") Once
printed, the pattern must be affixed to a flat surface. The easiest
...
1.  Before beginning, print out the calibration chessboard pattern and
    affix it to a flat surface. See
    [Calibrating_your_camera\#Setting_up](/Calibrating_your_camera#Setting_up "wikilink").
2.  After launching the app, you can use the Settings menu to choose the
    ...
    on the Action Bar at the top of the screen (on Android devices
    without a hardware menu button).
3.  Collect calibration images. See
    [Calibrating_your_camera\#Capturing_calibration_images](/Calibrating_your_camera#Capturing_calibration_images "wikilink").
